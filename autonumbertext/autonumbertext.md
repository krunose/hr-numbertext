Mapa koja u kojoj se nalazi skripta mora sadržavati još pet datoteka: `numbers.txt`, `tillFemininum.txt`, `femininum.txt`, `masculinum.txt` te datoteku `footer.txt`.
